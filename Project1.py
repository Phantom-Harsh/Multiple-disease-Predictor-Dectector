...
if (selected == 'Heart Disease Prediction'):
    ...
    load_clf = pickle.load(
        open('/home/phantom/Desktop/Python/heart_disease_model.pkl', 'rb'))
...
if (selected == 'Diabetes Prediction'):
    ...
    model = pickle.load(
        open('/home/phantom/Desktop/Python/model_DIAB.pkl', 'rb'))
    if st.button('Predict'):
...
if (selected == "Parkinsons Prediction"):
    ...
    parkinsons_model = pickle.load(open(
        '/home/phantom/Desktop/Python/parkinsons_model.sav', 'rb'))
...
if (selected == 'Hepatitis Mortality Predictor'):
    ...
    loaded_model = joblib.load(
        open('/home/phantom/Desktop/Python/decision_tree_clf_hepB_model.pkl', 'rb'))
...
if (selected == 'Pneumonia Detector'):  
    ...
    # Loading model
        MODEL = "/home/phantom/Desktop/Python/pneumonia_classifiers.h5"
